...
import com.joser.servlet.AtmServlet;
import com.joser.servlet.WithdrawalServlet;
...
public class AtmServer {
    ...
    public AtmServer(int port, CashSlot cashSlot, Account account) throws Exception {
